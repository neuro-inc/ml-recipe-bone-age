...
def get_parser() -> ArgumentParser:
    ...
    # `(eval_fold, n_folds)`: during training split data to `n_folds`,
    # use `eval_fold` for evaluation and remaining folds for training
    parser.add_argument('--dataset_split', type=Tuple[int], default=(10, 10))
    parser.add_argument('--model_type', type=str, default='age', choices=['age', 'gender'])
